                    ...
                    <div className="overflow-x-auto" style={{ padding: "30px" }}>
                        <form>
                            ...
                            <div className="flex w-full">
                                <div className="card rounded-box grid grow p-8" style={{ padding: "30px" }}>
                                    <fieldset className="fieldset w-full">
                                        <label className="fieldset-legend" htmlFor="nomeEmpresarial">
                                            Nome Empresarial
                                        </label>
                                        <input
                                            type="text"
                            ...
                            <div className="flex w-full">
                                <div className="card rounded-box grid grow p-8" style={{ padding: "30px" }}>
                                    <fieldset className="fieldset w-full">
                                        ...
                                        <IMaskInput
                                            ...
                                            value={empresa.cnpj}
                                            onAccept={(value) => setEmpresa({ ...empresa, cnpj: value })}
                                            className="input input-bordered w-full"
                                            id="cnpj"
                                        />
                                    </fieldset>
                                ...
                                <div className="card rounded-box grid grow p-8" style={{ padding: "30px" }}>
                                    <fieldset className="fieldset w-full">
                                        <label className="fieldset-legend" htmlFor="inscricaoEstadual">
                                            Inscrição Estadual
                                        </label>
                                        <input
                                            type="text"
                            ...
                            <div className="flex w-full">
                                <div className="card rounded-box grid grow p-8" style={{ padding: "30px" }}>
                                    <fieldset className="fieldset w-full">
                                        ...
                                        <IMaskInput
                                            mask="(00) 0 0000.0000"
                                            value={empresa.fone}
                                            onAccept={(value) => setEmpresa({ ...empresa, fone: value })}
                                            className="input input-bordered w-full"
                                            id="fone"
                                        />
                                    </fieldset>
                                ...
                                <div className="card rounded-box grid grow p-8" style={{ padding: "30px" }}>
                                    <fieldset className="fieldset w-full">
                                        <label className="fieldset-legend" htmlFor="foneAlternativo">
                                            Telefone Alternativo
                                        </label>
                                        <IMaskInput
                                            mask="(00) 0 0000.0000"
                                            value={empresa.foneAlternativo}
                                            onAccept={(value) => setEmpresa({ ...empresa, foneAlternativo: value })}
                                            className="input input-bordered w-full"
                                            id="foneAlternativo"
                                        />
                                    </fieldset>
